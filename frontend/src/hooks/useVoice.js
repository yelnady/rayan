...
export function useVoice() {
    ...
    const chunksRef = useRef([]); // accumulate base64 chunks in-memory
    ...
    const startVAD = useCallback((capture, onSilence) => {
