 ...
 */
function pcmToWav(pcmBytes, sampleRate = GEMINI_SAMPLE_RATE) {
    const numChannels = 1;
    ...
    const write = (offset, val) => [...val].forEach((c, i) => view.setUint8(offset + i, c.charCodeAt(0)));
    write(0, 'RIFF');
